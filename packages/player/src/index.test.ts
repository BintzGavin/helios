...
describe('HeliosPlayer', () => {
  ...
  describe('fastSeek and canPlayType', () => {
    let mockController: any;
    ...
    it('should test fastSeek coverage', async () => {
        player.fastSeek(10);
        expect(mockController.seek).toHaveBeenCalledWith(300); // 10 * 30 fps
    });

    it('should test canPlayType', () => {
