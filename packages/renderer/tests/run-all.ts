...
const tests = [
  ...
  'tests/verify-browser-install.ts',
  ...
  'tests/verify-distributed-audio.ts',
  'tests/verify-distributed-cancellation.ts',
  'tests/verify-distributed-progress.ts',
  'tests/verify-diagnose.ts',
  'tests/verify-diagnose-ffmpeg.ts',
  'tests/verify-diagnose-mock.ts',
  ...
  'tests/verify-seek-hook-errors.ts',
  ...
  'tests/verify-webcodecs-preference.ts',
