...
## Recent Updates
- [v0.83.0] ✅ Completed: Smart Empty State - Implemented "Smart Empty State" for the Stage, providing clear calls-to-action for creating or selecting compositions when the stage is empty. Verified with unit tests.
