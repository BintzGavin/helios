...
## Recent Updates
- [v0.83.0] ✅ Completed: Audio Waveforms - Implemented visual audio waveforms on the Timeline tracks using `OfflineAudioContext` for visualization and refactored audio state management.
