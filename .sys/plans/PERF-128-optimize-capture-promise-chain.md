...
```
This is a purely synchronous function that returns a constructed promise chain, avoiding `async`/`await` allocation overhead entirely (similar to the goals of PERF-088 and PERF-126).
