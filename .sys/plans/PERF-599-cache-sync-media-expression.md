...
# PERF-599: Cache sync media CDP expression in CdpTimeDriver
...
**Risk**: If `timeInSeconds` is not perfectly deterministic (e.g., floating point imprecision), the cache could grow unbounded. However, `timeInSeconds` is deterministic.
