...
### How It Works
The system uses a **Black Hole Architecture**—a planning-execution cycle designed to simulate a fully autonomous engineering team where agents continuously pull the codebase toward the documented vision:
