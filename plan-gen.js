...
const planId = 'PERF-865'; // Ensure unique ID
const slug = 'fast-reusable-thenable';
const filename = `.sys/plans/${planId}-${slug}.md`;
...
# ${planId}: Fast ReusableThenable Implementation
...
fs.writeFileSync(filename, planContent);
